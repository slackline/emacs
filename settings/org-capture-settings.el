...
(setq org-capture-templates
	...
	;; Drugs
	("d" "Drugs")
	("dd" "DMT" entry (file+olp "~/org/drugs.org" "DMT")
	 "+ %?\n" :prepend t)
	("ddp" "DMT" entry (file+olp "~/org/drugs.org" "DMT" "Popular Science")
	 "+ %?\n" :prepend t)
	("ddr" "DMT" entry (file+olp "~/org/drugs.org" "DMT" "Peer Reviewed")
	 "+ %?\n" :prepend t)
	("dl" "LSD" entry (file+olp "~/org/drugs.org" "LSD")
	 "+ %?\n" :prepend t)
	("dlp" "Popular Science" entry (file+olp "~/org/drugs.org" "LSD" "Popular Science")
	 "+ %?\n" :prepend t)
	("dlr" "Peer Reviewed" entry (file+olp "~/org/drugs.org" "LSD" "Peer Reviewed")
	 "+ %?\n" :prepend t)
	("dl" "Psilocybin" entry (file+olp "~/org/drugs.org" "Psilocybin")
	 "+ %?\n" :prepend t)
	("dpp" "Popular Science" entry (file+olp "~/org/drugs.org" "Psilocybin" "Popular Science")
	 "+ %?\n" :prepend t)
	("dpr" "Peer Reviewed" entry (file+olp "~/org/drugs.org" "Psilocybin" "Peer Reviewed")
	 "+ %?\n" :prepend t)
	("do" "Books" entry (file+olp "~/org/drugs.org" "Books")
	 "+ %?\n" :prepend t)
	("di" "Interviews" entry (file+olp "~/org/drugs.org" "Interviews")
	 "+ %?\n" :prepend t)
	("db" "Blogs" entry (file+olp "~/org/drugs.org" "Blogs")
	 "+ %?\n" :prepend t)
	("dr" "Terrence McKenna" entry (file+olp "~/org/drugs.org" "Terrence McKenna")
	 "+ %?\n" :prepend t)
	;; Exercise
	("e" "Exercise")
	...
	("rg" "Genetics" entry (file+olp "~/org/reading.org" "Genetics")
         "* TODO %?\n" :prepend t)
	("rs" "Statistics" entry (file+olp "~/org/reading.org" "Statistics")
         "* TODO %?\n" :prepend t)
	;; TODO
	...
	("viv" "Vaccine" item (file+olp "~/org/coronavirus.org" "Immunity / Testing / Vaccine" "Vaccine")
         "+ %t %?\n" :prepend t)
	("ve" "Independant SAGE" item (file+olp "~/org/coronavirus.org" "Independent SAGE")
         "+ %t %?\n" :prepend t)
	...
	;; Work
	("w" "Work")
	("wp" "Work Projects" entry (file+olp "~/org/thefloow/thefloow.org" "Project")
	 "** TODO %t %?\n" :prepend t)
	("wd" "Work Projects" entry (file+olp "~/org/thefloow/dawid.org" "Project")
	 "** TODO %t %?\n" :prepend t)
