  ...
  (setq org-capture-templates
      '(;; Email
	    ...
	    ("es" "Steps" table-line (file+olp "~/org/training/log/metrics_steps.org")
	     "| %t | %? |" :prepend t)
	    ("eb" "Blood" table-line (file+olp "~/org/training/log/metrics_blood.org")
	     "| %U | %? | | | | | |" :prepend t)
	    ...
	    ("etc" "Calisthenics" entry (file+olp "~/org/training/training.org" "Resources" "Calisthenics")
         "+ %t %?\n" :prepend t)
	    ("etcr" "Recommended Routine" entry (file+olp "~/org/training/training.org" "Resources" "Calisthenics" "Recommneded
Routine")
         "+ %t %?\n" :prepend t)
