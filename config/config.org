...
#+NAME: code-block-use-package-install
...
#+NAME: code-block-use-package-config
#+BEGIN_SRC emacs-lisp :tangle yes
...
#+NAME: code-block-yasnippet-config
#+BEGIN_SRC emacs-lisp :tangle yes
...
#+NAME: code-block-reinstall-package
#+BEGIN_SRC emacs-lisp :tangle yes
