...
[[https://github.com/kwrooijen/cargo.el][cargo.el]] is in maintenance mode but provides a set of key combinations to perform [[https://doc.rust-lang.org/cargo/][Cargo]] tasks.
#+NAME: code-cargo-el
#+BEGIN_SRC emacs-lisp :tangle no
body
#+END_SRC
...
[[https://github.com/ayrat555/cargo-mode][cargo-mode]] is a minor mode for dynamically selecting commands from the Rust package manager [[https://doc.rust-lang.org/cargo/][Cargo]].
