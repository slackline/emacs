...
#+BEGIN_SRC emacs-lisp :tangle init.el
  (use-package emacs
    ...
    (add-to-list 'display-buffer-alist
	 ...
	 (allow-no-window . t)))
    :bind (("C-c U" ("Revert buffer (aka Undo)" . revert-buffer))
	    ("C-c D" ("Toggle debug on error" . toggle-debug-on-error))
	    ;; Org
...
*TODO* - Bind some keys for code folding.
...
[[https://github.com/kiennq/treesit-langs][treesit-langs]] "/is a convenient language bundle for the Emacs package [[sec:tree-sitter][tree-sitter]]/" its a fork of [[https://github.com/emacs-tree-sitter/tree-sitter-langs][tree-sitter-langs]].

As I use the newer [[sec:treesit][treesit]] I'm not sure this is required.

Not currently tangled.

#+NAME: code-treesit-langs
#+BEGIN_SRC emacs-lisp :tangle init.el
...
(use-package mpdel
  ...
  :bind-keymap ("C-x Z" . ("MPDel" . mpdel-core-map)))
;; (mpdel-mode)
...
(use-package centaur-tabs
  ...
  ("C-<prior>" ("Tab backwards" . centaur-tabs-backward))
  ("C-<next>" ("Tab forwards" .centaur-tabs-forward)))
