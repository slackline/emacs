...
#+NAME: code-lsp-mode
#+BEGIN_SRC emacs-lsp :tangle yes
...
plain [[https://jedi.readthedocs.io/en/latest/][Jedi]] before I started using [[src:lsp-mode][lsp-mode]] and its not written my Micro$oft like some of the others.
...
configure/use it properly as it contains the modules that add [[src:flycheck][Flycheck]] support and a few other things.
...
should really get into using something like [[src:realgud][RealGUD]] instead.
...
[[https://github.com/kiennq/treesit-langs][treesit-langs]] "/is a convenient language bundle for the Emacs package [[src:tree-sitter][tree-sitter]]/" its a fork of [[https://github.com/emacs-tree-sitter/tree-sitter-langs][tree-sitter-langs]].

As I use the newer [[src:treesit][treesit]] I'm not sure this is required.
