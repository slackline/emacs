...
(use-package ssh-agency
  ...
  :map ("C-c C-s" . '(ssh-agency-keys '("~/.ssh/id_ed25519" "~/.ssh/haldane_ed25519"))))
...
[[https://www.orgroam.com/manual.html][Org-roam]] is a Zettelkasten package for taking notes. It leverages an [[sec:sqlite][sqlite]] database in the background to keep track of
...
[[https://github.com/tefkah/org-roam-timestamps][org-roam-timestamps]] adds timestamps to the header of Org-roam files for creation and modification.
