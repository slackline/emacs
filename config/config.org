...
[[repo_url][ibuffer]] is built-in. A useful example of configuration is [[https://olddeuteronomy.github.io/post/emacs-ibuffer-config/][here]].
...
[[https://github.com/purcell/ibuffer-vc][ibuffer-vc]] is a neat extension which groups buffers in [[sec:ibuffer][ibuffer]] by version control groups.
