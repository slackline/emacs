...
<<sec:org-copy-link-at-point>>

From [[https://emacs.stackexchange.com/a/63051][NickD on Emacs StackExchange]], it almost does what I was after but copies the whole [[sec:org-mode][org-mode]] link.

#+NAME: code-org-copy-link-at-point
#+BEGIN_SRC emacs-lisp :tangle no
(defun ns/link-fast-copy ()
