...
+ [ ] [[https://www.jamescherti.com/emacs-startup-defer-use-package-performance/][Optimizing Emacs startup - Guide to deferred package loading with use-package | James Cherti]]
